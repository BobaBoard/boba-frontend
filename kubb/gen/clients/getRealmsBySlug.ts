 ...
 */
export async function getRealmsBySlug<TData = GetRealmsBySlugQueryResponse>(realmSlug: GetRealmsBySlugPathParams["realm_slug"], options: Partial<Parameters<typeof client>[0]> = {}): Promise<ResponseConfig<TData>> {
   return client<TData>({
      method: "get",
