 ...
 */
export async function updateThreadExternalId<TData = UpdateThreadExternalIdMutationResponse,TVariables = UpdateThreadExternalIdMutationRequest>(threadId: UpdateThreadExternalIdPathParams["thread_id"], data?: TVariables, options: Partial<Parameters<typeof client>[0]> = {}): Promise<ResponseConfig<TData>> {
