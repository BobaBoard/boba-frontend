 ...
 */
export async function postComment<TData = PostCommentMutationResponse,TVariables = PostCommentMutationRequest>(postId: PostCommentPathParams["post_id"], data?: TVariables, options: Partial<Parameters<typeof client>[0]> = {}): Promise<ResponseConfig<TData>> {
