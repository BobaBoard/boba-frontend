 ...
 */
export async function getCurrentUserNotifications<TData = GetCurrentUserNotificationsQueryResponse>(realmId: GetCurrentUserNotificationsPathParams["realm_id"], options: Partial<Parameters<typeof client>[0]> = {}): Promise<ResponseConfig<TData>> {
   return client<TData>({
      method: "get",
