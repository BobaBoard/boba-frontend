 ...
 */
export async function unhideThreadByExternalId<TData = UnhideThreadByExternalIdMutationResponse>(threadId: UnhideThreadByExternalIdPathParams["thread_id"], options: Partial<Parameters<typeof client>[0]> = {}): Promise<ResponseConfig<TData>> {
   return client<TData>({
      method: "delete",
