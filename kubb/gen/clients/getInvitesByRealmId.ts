 ...
 */
export async function getInvitesByRealmId<TData = GetInvitesByRealmIdQueryResponse>(realmId: GetInvitesByRealmIdPathParams["realm_id"], options: Partial<Parameters<typeof client>[0]> = {}): Promise<ResponseConfig<TData>> {
   return client<TData>({
      method: "get",
