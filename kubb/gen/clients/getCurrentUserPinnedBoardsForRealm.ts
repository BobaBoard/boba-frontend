 ...
 */
export async function getCurrentUserPinnedBoardsForRealm<TData = GetCurrentUserPinnedBoardsForRealmQueryResponse>(realmId: GetCurrentUserPinnedBoardsForRealmPathParams["realm_id"], options: Partial<Parameters<typeof client>[0]> = {}): Promise<ResponseConfig<TData>> {
   return client<TData>({
      method: "get",
